...
import blossom = require('edmonds-blossom');
...
export class MST {
    ...
    */
    convertEdgePathToTree = ({ path, undirected, edgeSort }: { path: Edge[], prioritizeLeafNodes?: boolean, undirected?: boolean, edgeSort?: EdgeSort }): AdjencyList => {
